  ...
  return (
    <section className="relative overflow-hidden bg-black text-white">
      ...
      <PublicContainer className="relative flex min-h-[620px] flex-col items-center justify-center gap-10 py-24 text-center sm:py-32">
        <div className="realty-animate-fade-up flex max-w-4xl flex-col items-center gap-6">
        ...
        {children && <div className="realty-animate-scale-in realty-animate-delay-2 w-full max-w-5xl">{children}</div>}
      </PublicContainer>
    </section>
  );
}
